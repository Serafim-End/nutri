...
➖ Предупреждать об отмене или переносе консультации <b>не менее чем за 12 часов</b>
➖ Отвечать на сообщения клиентов <b>в течение 24 часов</b>

4️⃣ <b>Финансы</b>
➖ Комиссия платформы: 20%
➖ Выплаты специалистам: <b>еженедельно</b>

5️⃣ <b>Отмена бронирования</b>
➖ Клиент может отменить консультацию <b>за 12 часов и более: полный возврат средств</b>
➖ При отмене менее чем <b>за 12 часов: возврат 50% стоимости</b>
➖ Неявка на консультацию: <b>без возврата средств</b>
